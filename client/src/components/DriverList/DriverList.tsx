...
function DriverList (): JSX.Element {
  ...
  function createData (name: string, position: string, points: string, wins: string, nationality: string, constructorName: string, age: string): data {
  ...
  for (const driver of driversMap.values()) {
    ...
    const name = `${givenName as string} ${familyName as string}`
